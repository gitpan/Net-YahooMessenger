...
sub body {
    my ($self,$message) = @_;
    if (defined $message) {
        $message .= YMSG_SEPARATOR . '63' . YMSG_SEPARATOR . ';0' . YMSG_SEPARATOR . '64' . YMSG_SEPARATOR . '0' . YMSG_SEPARATOR . '1002' . YMSG_SEPARATOR . '1' . YMSG_SEPARATOR . '206' . YMSG_SEPARATOR . '0'; 
    }
